import SearchResultsLoader, {
  searchResultsGridSx,
} from "@/containers/places/content/loader/SearchResultsLoader";
import PlaceCard from "@/containers/places/content/cards-section/place-card/PlaceCard";
import { Stack } from "@mui/material";
import { useAppSelector } from "@/store/hooks";
import { selectHasMore, selectItems } from "@/store/search-slice/search.slice";
import ScrollPositionTracker from "@/containers/places/content/cards-section/ScrollPositionTracker";
