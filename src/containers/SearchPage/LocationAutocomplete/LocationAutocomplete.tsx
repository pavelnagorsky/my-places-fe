...
export function LocationAutocomplete({onSetPlaceId, setValue, value}: ILocationAutoSelectProps) {
    ...
    useEffect(() => {
        ...
        fetch({ input: inputValue, componentRestrictions: { country: defaultCountrySign } }, (results?: readonly PlaceType[]) => {
            if (active) {
