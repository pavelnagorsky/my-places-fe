...
import usePlaceCategory from "@/containers/admin/place-categories/place-category/usePlaceCategory";
...
const PlaceCategoryHeader = () => {
  const logic = usePlaceCategory();
  const { watch, formState } = useFormContext<IPlaceCategoryFormContext>();
...
export default PlaceCategoryHeader;
