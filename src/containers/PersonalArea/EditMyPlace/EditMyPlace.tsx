...
import useEditMyPlace from "@/containers/PersonalArea/EditMyPlace/useEditMyPlace";
import {
  Backdrop,
  Box,
  Button,
...
import Navigation from "@/containers/CreatePlace/Form/Navigation";
                ...
                >
                  <Box overflow={"hidden"}>
                    ...
                    <Box mt={"0.5em"}>
                      ...
                      />
                      <FormHelperText>
                        Обновить переводы на другие языки
                      </FormHelperText>
                    </Box>
                  </Box>
                  <div>
