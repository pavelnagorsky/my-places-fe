    ...
    >
        <Stack minWidth={"203px"} px={"1em"} py={"1.5em"}>
            <SliderMenuLink
                ...
                icon={<CollectionsOutlinedIcon fontSize={"small"} color={"secondary"} />}
            />
            <SliderMenuLink
                pathname={pathname}
                onClick={onClose}
            ...
            />
            <Divider variant={"middle"} sx={{ borderColor: "primary.main", opacity: 0.5, my: "0.3em" }} />
            <Button
                sx={{
                    textTransform: "none",
...
const SliderMenuLink = ({icon, text, href, pathname, onClick}: ISliderMenuLinkProps) => {
    return <Stack direction={"row"} width={"100%"} alignItems={"center"} onClick={onClick}>
        <Box sx={{
            "& a": {
                p: "0.5em",
                color: "secondary.main",
