...
const Footer = () => {
    ...
    const linksSection = (<Stack direction={"row"} gap={"3em"}>
    ...
    const footerText = (<Stack direction={"column"} alignItems={"center"}>
    ...
    return <Stack direction={"row"} alignItems={"center"} justifyContent={"space-between"} mb={"2em"}>
